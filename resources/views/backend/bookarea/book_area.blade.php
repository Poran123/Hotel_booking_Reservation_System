                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        ...
                                        <textarea  class="form-control" name="short_desc" rows="3" id="">{{ $book->short_desc }}</textarea>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        ...
                                        <img id="showImage" src="{{ asset($book->image) }}" alt="Admin" class="p-1 mt-2 rounded-circle bg-primary" width="60">
                                    </div>
                                </div>
                                <div class="row">
