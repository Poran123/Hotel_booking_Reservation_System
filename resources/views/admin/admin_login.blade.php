...
<head>
	...
	<!--favicon-->
	<link rel="icon" href="{{asset('backend/')}}" type="image/png" />
	<!--plugins-->
		...
		<div class="section-authentication-cover">
			<div class="">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="login" class="form-control @error('login') is-invalid @enderror" id="login" placeholder="21103057@iubat.edu">
                    @error('login')
